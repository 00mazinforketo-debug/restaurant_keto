...
const seed = async () => {
  ...
  const admin = await prisma.user.create({
    data: {
      ...
      role: adminAccount.role as UserRole,
      preferredLocale: adminAccount.preferredLocale as Locale,
      ...
      .map(async (account) =>
        prisma.user.create({
          data: {
            ...
            preferredLocale: account.preferredLocale as Locale,
  ...
  await prisma.$transaction(
    ketoCatalogCategories.map((category) =>
